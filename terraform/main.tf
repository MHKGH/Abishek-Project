...
resource "aws_acm_certificate" "nginx_cert" {
  domain_name       = "abhiram-tech.click"
...
resource "aws_route53_record" "cert_validation" {
  for_each = {
    for dvo in aws_acm_certificate.nginx_cert.domain_validation_options : dvo.domain_name => {
